#!/usr/bin/env python3
"""
🔥 Holarchy 문서 자동 배치 시스템
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

기능:
- 입력 텍스트를 분석하여 적절한 HTE 모듈(M00~M21) 결정
- 해당 모듈 폴더에 파일명 규칙에 따라 생성
...
class DocumentPlacer:
    ...
    def generate_filename(self, module_id: str, p_num: int = None, t_num: int = None) -> str:
        """파일명 생성: HTE_MXX_PYY_TZZ_V00_A00.md"""
        if p_num is None or t_num is None:
            p_num, t_num = self.get_next_file_number(module_id)
        
        return f"HTE_{module_id}_P{p_num:02d}_T{t_num:02d}_V00_A00.md"
    ...
    def create_document(self, text: str, doc_type: str = "auto") -> Dict:
        """문서 생성"""
        print("=" * 60)
        ...
        # 2. 파일명 생성
        p_num, t_num = self.get_next_file_number(module_id)
        filename = self.generate_filename(module_id, p_num, t_num)
