```json
{
  ...
  "W": {
    "worldview": {
      "identity": "[학생 진단 리포트의 정체성을 정의하세요]",
      "belief": "[핵심 믿음을 정의하세요]",
    ...
    "activation": {
      ...
      "resonance_check": "이 문서가 상위 W와 공명하는가? (상위: hte-doc-002)",
  ...
  "A": {
    ...
    "integration_targets": [],
    "resonance_logic": "상위 W(hte-doc-002)와의 공명 유지",
